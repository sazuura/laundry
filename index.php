    ...
    <div class="navbar-custom-menu">
      ...
      <li class="dropdown user user-menu" style="padding-top: 5px;"> 
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs" style="color: white">Hai, <?php echo $nama?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="logout.php" class="btn btn-default btn-flat" onclick="return confirm('Apakah anda ingin logout ?');">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
...
<?php include "include/menu.php"; ?>
  ...
  <footer class="main-footer dark-mode">
    <strong>Copyright &copy; 2024 <a href="#">Salma Laundry</a>.</strong> All rights reserved.
  </footer>
